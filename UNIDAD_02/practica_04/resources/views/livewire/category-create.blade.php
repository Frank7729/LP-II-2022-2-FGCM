            ...
            <form>
                ...
                <div class="flex justify-between mx-2 mb-6">
                    <div class="mb-2 md:mr-2 md:mb-0 w-full">
                        ...
                        <x-jet-input type="text" wire:model="category.slug" class="w-full" />
                        <x-jet-input-error for="category.slug" />
                    </div>
                </div>
                <div class="flex justify-between mx-2 mb-6">
                    <div class="mb-2 md:mr-2 md:mb-0 w-full">
                        <x-jet-label value="Nombre de la description" class="font-bold" />
                        <x-jet-input type="text" wire:model="category.description" class="w-full" />
